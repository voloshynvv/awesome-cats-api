import { ButtonProps, Dialog as ChakraDialog, Portal } from '@chakra-ui/react';
...
type DialogCloseTrigger = ChakraDialog.CloseTriggerProps & ButtonProps;

export const DialogCloseTrigger = React.forwardRef<HTMLButtonElement, DialogCloseTrigger>(
